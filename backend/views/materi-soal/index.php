...
<div class="module-materi-soal-index">
    <div class="box box-success">
        <div class="box-header">
                ...
                <p>
                    <?= Html::a('Tambah Module Materi Soal', ['create'], ['class' => 'btn btn-success']) ?>
        ...
        <div class="box-body">
                ...
                'filterInputOptions' => ['placeholder' => 'Module materi', 'id' => 'grid-module-materi-soal-search-materi_id']
            ],
                                'judul',
                                'isi:ntext',
