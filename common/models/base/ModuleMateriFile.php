...
/**
 * This is the base model class for table "module_materi_file".
 *
 * @property integer $id
 ...
 */
class ModuleMateriFile extends \yii\db\ActiveRecord
{
    ...
    */
    ...
    /**
     * @inheritdoc
     * @return \app\models\ModuleMateriFileQuery the active query used by this AR class.
     */
    public static function find()
    {
        $query = new \app\models\ModuleMateriFileQuery(get_called_class());
        return $query->where(['module_materi_file.deleted_by' => 0]);
    }
}
