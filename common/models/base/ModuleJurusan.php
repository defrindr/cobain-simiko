...
/**
 * This is the base model class for table "module_jurusan".
 *
 * @property integer $id
 ...
 */
class ModuleJurusan extends \yii\db\ActiveRecord
{
    ...
    */
    ...
    {
        return $this->hasMany(\common\models\ModuleKelas::className(), ['jurusan_id' => 'id']);
    }
    ...
    /**
     * @inheritdoc
     * @return \app\models\ModuleJurusanQuery the active query used by this AR class.
     */
    public static function find()
    {
